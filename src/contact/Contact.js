            ...
            <div className="col mb-5 mb-lg-0 position-relative">
              ...
              <div className="container pt-5">
                <div className="row text-danger ms-md-auto">
                  <p className="col-md-3 ms-md-auto contactdetail" style={{marginRight:'60px'}}>
                  You can reach me at <br />
                    <span>harshitapaliwal789@gmail.com</span>
                  </p>
                  <p className="col-md-3 contactdetail ms-md-5">
                    OR Contact me at <br />
                    <span>+91 8269637588</span>
                  </p>
                </div>
              </div>
            </div>
